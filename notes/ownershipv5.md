...
ƒ_ρ + ƒ_x ↓ ƒ_n
-------------------------------------------------------------------- T-Drop
Σ; Δ; Ρ; Γ, x : τ ↦ ρ_x ⊢ drop x : unit ⇒ Ρ, ρ_x ↦ ƒ_n ⊗ path_set; Γ

Ρ(ρ_x) = 1 ⊗ { ε ↦ τ }
Ρ' = Ρ - ρ_x
----------------------------------------------------------------------- T-FreeImmediate
Σ; Δ; Ρ; Γ, x : τ ↦ ρ_x ⊢ drop x : unit ⇒ Ρ'; Γ
...
Σ; Δ; Ρ; Γ ⊢ e_1 : &r f (τ_1 ⊗ ... ⊗ τ_n) ⇒ Ρ_1; Γ_1
f ≠ 0
Σ; Δ; Ρ_1; Γ_1, x_1 : τ_1 ↦ Ρ(r).1,
                ...
                x_n : τ_n ↦ Ρ(r).n,
                ⊢ e_2 : t_r ⇒ Ρ_2; Γ_2
r ∉ Ρ_2
...
mut ∈ { μ_1, ..., μ_n }
Σ; Δ; Ρ; Γ ⊢ e_1 : &r 1 (τ_1 ⊗ ... ⊗ τ_n) ⇒ Ρ_1; Γ_1
Σ; Δ; Ρ_1; Γ_1, x_1 : τ_1 ↦ Ρ(r).1,
                ...
                x_n : τ_n ↦ Ρ(r).n,
                ⊢ e_2 : t_r ⇒ Ρ_2; Γ_2
