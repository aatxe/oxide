...
Ρ(Γ(x).r) = ƒ_x ⊗ path_set
ƒ_x ≠ 0
canonize(π) = π_c
;; walk the path through Ρ, checking that f ≠ 0, and return r_π
Ρ; path_set ⊢ π_c : τ_π ⇒ r_π
Ρ(r_π) = ƒ_π ⊗ π_path_set
ƒ_π / 2 ↓ ƒ_n
fresh ρ
------------------------------------------------------------------------- T-BorrowImm
Σ; Δ; Ρ; Γ ⊢ borrow imm x.π : &ρ ƒ_π τ_π ⇒ Ρ, r_π ↦ ƒ_n ⊗ π_path_set,
                                              ρ ↦ ƒ_n ⊗ { ε ↦ r_π }; Γ
...
fresh ρ
------------------------------------------------------------------------- T-BorrowMut
Σ; Δ; Ρ; Γ ⊢ borrow mut x.π : &ρ ƒ_π τ_π ⇒ Ρ, r_π ↦ 0 ⊗ π_path_set,
                                              ρ ↦ ƒ_π ⊗ { ε ↦ r_π }; Γ
...
ƒ_r + ƒ_x ↓ ƒ_n
-------------------------------------------------------------------- T-Drop
Σ; Δ; Ρ; Γ, x : τ ↦ r_x ⊢ drop x : unit ⇒ Ρ, r ↦ ƒ_n ⊗ path_set; Γ

Ρ(r_x) = 1 ⊗ { ε ↦ τ }
Ρ' = Ρ - r_x
----------------------------------------------------------------------- T-FreeImmediate
Σ; Δ; Ρ; Γ, x : τ ↦ r_x ⊢ drop x : unit ⇒ Ρ'; Γ

Ρ(r_x) = 1 ⊗ { Π_1 ↦ r_1, ..., Π_n ↦ r_n }
...
Σ; Δ; Ρ; Γ ⊢ e_1 : (&r_1 f_1 τ_1 ⊗ ... ⊗ &r_n f_n τ_n) ⇒ Ρ_1; Γ_1
f_1 ≠ 0 ... f_n ≠ 0
Σ; Δ; Ρ_1; Γ_1, x_1 : τ_1 ↦ r_1,
                ...
                x_n : τ_n ↦ r_n,
                ⊢ e_2 : t_r ⇒ Ρ_2; Γ_2
r ∉ Ρ_2
----------------------------------------------------------------- T-LetTupImm
Σ; Δ; Ρ; Γ ⊢ let (imm x_1, ..., imm x_n): τ_1 ⊗ ... ⊗ τ_n = e_1
             in e_2 : τ_r ⇒ Ρ_2; Γ_2
